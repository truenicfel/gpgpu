========================================================================
    KONSOLENANWENDUNG: OpenCVReadVideo-Projektübersicht
========================================================================

Diese OpenCVReadVideo-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre OpenCVReadVideo-Anwendung besteht.


OpenCVReadVideo.vcxproj
...
OpenCVReadVideo.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen OpenCVReadVideo.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
